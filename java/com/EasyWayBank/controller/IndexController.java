...
import com.EasyWayBank.repository.UserRepository;
...
public class IndexController {
    ...
    public ModelAndView getLogin() {
        ModelAndView getRegisterPage = new ModelAndView("foldername/register");
        System.out.println("In Register Page Controller");
        getRegisterPage.addObject("pageTitle", "LoginPage");
        return getRegisterPage;
    }

    @GetMapping("/register")
    public ModelAndView getError() {
        ModelAndView getErrorPage = new ModelAndView("foldername/register");
        System.out.println("In Register Page Controller");
        getErrorPage.addObject("pageTitle", "LoginPage");
        return getErrorPage;
